---
description: "Use when migrating or reviewing HA Notifications EventBus flows, application orchestration, gateway ports, runtime ordering, persistence, or effect boundaries."
