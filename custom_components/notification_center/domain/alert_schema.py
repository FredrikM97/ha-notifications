...
def normalize_target(
    ...
    for key in (
        ...
        values = [str(item) for item in _list(target.get(key)) if item]
...
def normalize_notification(
    ...
    normalized_confirmation = {
        ...
        "confirmation_message": str(confirmation.get("confirmation_message") or ""),
        "clear_on_confirmation": bool(confirmation.get("clear_on_confirmation", True)),
